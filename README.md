...
user. All commands should start with the prefix you specified at install and can be sent
...
if I selected my bots prefix to be, ``deadbot`` I would use ``deadbot calc 1+1``
For this README, the bots prefix will be, ``deadbot``, fust for the examples
